...
class UserRepository {
    ...
    try {
      ...
      if (response.data['quota'] != null) {
        return QuotaStatus.fromJson(
            response.data['quota'] as Map<String, dynamic>);
      } else {
  ...
  Future<Map<String, dynamic>> submitSecondIntake(
  ...
  Future<UserProfile> updateSubscription(String tier) async {
    try {
      ...
      throw Exception(
          e.response?.data['message'] ?? 'Failed to update subscription');
    }
  }
  ...
  Future<Map<String, dynamic>> getCoachProfileSettings() async {
    try {
      ...
      throw Exception(
          e.response?.data['message'] ?? 'Failed to load coach profile');
    }
  }
  ...
  Future<Map<String, dynamic>> getAdminProfileSettings() async {
    try {
      ...
      throw Exception(
          e.response?.data['message'] ?? 'Failed to load admin profile');
    }
  }
